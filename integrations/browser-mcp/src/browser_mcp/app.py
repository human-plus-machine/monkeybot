...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "not attempt to type a password. It may block up to 150s if the user "
        "needs to approve the sign-in. If the result is 'waiting for your "
        "approval', 'agent access denied for this site', or 'grant expired', "
        "stop and tell the user; do not retry. If the mfa field is 'needed', "
        "tell the user to add an authenticator for this site in Spaces or "
        "finish signing in themselves; if it is 'completed', the one-time code "
        "was handled automatically and no further action is needed. "
