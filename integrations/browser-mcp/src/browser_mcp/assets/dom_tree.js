...
/**
 * @vendored-from page-agent packages/page-controller/src/dom/dom_tree/index.js
 * Converted from an ESM default export to a plain global assignment for CDP injection.
 */
window.__bmcpBuildDomTree = function (
	args = {
