"""Tests for the CLI realtime client frame handling."""

from __future__ import annotations

import json

from monkeybot.cli.realtime_client import _encode_client_frame, _is_exit_command
...
def test_encode_client_text_frame() -> None:
    ...
    encoded = json.loads(_encode_client_frame(frame))
