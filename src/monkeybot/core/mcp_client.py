...
``python -c "import monkeybot.core.mcp_client"`` succeeds without those packages installed.
...
class MCPClient:
    """MCP SDK client (stdio subprocesses and Streamable HTTP) for :class:`monkeybot.core.ports_mcp.MCPClientPort`."""
