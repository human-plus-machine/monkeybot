...
After a heartbeat cycle completes, the council reads raw observation files
from {memory_dir}/raw/, compresses each into a summary, classifies into
a typed folder, and updates INDEX.md for deterministic retrieval.
"""
...
from .interfaces import EmonkError
