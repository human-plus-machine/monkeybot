...
echo -e "  Sessions:    ${GREEN}POST ${SERVICE_URL}/sessions${NC}"
echo -e "  SSE stream:  ${GREEN}GET  ${SERVICE_URL}/sessions/{id}/events${NC}"
echo -e "  Reply:       ${GREEN}POST ${SERVICE_URL}/sessions/{id}/reply${NC}"
echo ""
